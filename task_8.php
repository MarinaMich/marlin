                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="show.php?id=<? echo $user['id'] ?>" class="btn btn-info">Просмотр</a>
                                                <a href="edit.php?id=<? echo $user['id'] ?>" class="btn btn-warning">Изменить</a>
                                                <a href="delete.php?id=<? echo $user['id'] ?>" class="btn btn-danger">Удалить</a>
                                            </td>
                                        </tr>
                                        <?php endforeach;?>
